    ...
    return (
        <MobileSidebarProvider>
            <div className="flex min-h-screen">
                {/* Mobile Sidebar (client component with overlay + slide-in panel) */}
                <MobileSidebar
                    profile={profile}
                ...
                <aside className="fixed left-0 top-0 z-40 hidden md:flex h-screen w-64 flex-col border-r border-border bg-surface">
                    {/* Logo */}
                ...
                <main className="md:ml-64 flex flex-1 flex-col overflow-hidden">{children}</main>
            </div>
        </MobileSidebarProvider>
    );
}
