...
export function CatLoader() {
    return (
        <div className="flex items-center justify-center w-fit h-fit relative">
            <style>{`
        .cat-tail {
          position: absolute;
          width: 17px;
            ...
            <div className="flex flex-col items-center justify-center w-fit h-fit">
                <div className="w-full h-fit flex items-center justify-center relative">
                    ...
                    <svg
                        ...
                        fill="none"
                        viewBox="0 0 158 564"
                        className="cat-tail text-foreground"
                    >
                        <path
                            fill="currentColor"
                    ...
                    <div className="text-zzz text-foreground">
                        <span className="zzz-big">Z</span>
